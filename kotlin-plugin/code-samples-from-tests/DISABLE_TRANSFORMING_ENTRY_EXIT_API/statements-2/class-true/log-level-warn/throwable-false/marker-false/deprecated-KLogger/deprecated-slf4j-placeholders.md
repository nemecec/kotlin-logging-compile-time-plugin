## featureFlag=DISABLE_TRANSFORMING_ENTRY_EXIT_API / With 2 log statement(s) / with class=true / with log level=WARN / with throwable=false / with marker=false / deprecated KLogger API / deprecated API with SLF4J placeholders
...
private val logger = KotlinLogging.logger {}
  ...
  fun main() {
    ...
    logger.at(Level.WARN) { message = "warn message 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"warn message {}\"", className = "test1116.MainTest", methodName = "main", fileName = "test1116.kt", lineNumber = 13)
  }
...
private val logger = KotlinLogging.logger {}
  ...
  fun main() {
    ...
    logger.at(Level.WARN) { message = "warn message with concatenation 42 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"warn message with concatenation $arg {}\"", className = "test1117.MainTest", methodName = "main", fileName = "test1117.kt", lineNumber = 13)
  }
...
private var arg: Long = 42
  fun main() {
    ...
    logger.at(Level.WARN) { message = "warn with extension function 42m interval"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"warn with extension function {} interval\"", className = "test1118.MainTest", methodName = "main", fileName = "test1118.kt", lineNumber = 13)
  }
...
private val logger = KotlinLogging.logger {}
  ...
  fun main() {
    ...
    logger.at(Level.WARN) { message = "warn message 42 Hello!{} abc {}"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"warn message {} \" + \"\" + \"{}\" + \"{}\" + \" abc\" + \" {}\"", className = "test1119.MainTest", methodName = "main", fileName = "test1119.kt", lineNumber = 13)
  }
  fun helper() = "Hello!"
}
...
private val logger = KotlinLogging.logger {}
  ...
  fun main() {
    ...
    logger.at(Level.WARN) { message = "warn message 1a 2b 12ab ab"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"warn message {}a\" + \" {}b\" + \" {}ab\" + \" ab\"", className = "test1120.MainTest", methodName = "main", fileName = "test1120.kt", lineNumber = 13)
  }
  fun ab() = 12
}
