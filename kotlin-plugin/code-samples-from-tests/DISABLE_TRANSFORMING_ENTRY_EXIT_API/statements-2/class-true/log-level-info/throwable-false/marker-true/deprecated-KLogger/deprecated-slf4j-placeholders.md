## featureFlag=DISABLE_TRANSFORMING_ENTRY_EXIT_API / With 2 log statement(s) / with class=true / with log level=INFO / with throwable=false / with marker=true / deprecated KLogger API / deprecated API with SLF4J placeholders
...
private val logger = KotlinLogging.logger {}
  ...
  fun main() {
    ...
    logger.at(Level.INFO, marker) { message = "info message 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"info message {}\"", className = "test1016.MainTest", methodName = "main", fileName = "test1016.kt", lineNumber = 13)
  }
...
private val logger = KotlinLogging.logger {}
  ...
  fun main() {
    ...
    logger.at(Level.INFO, marker) { message = "info message with concatenation 42 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"info message with concatenation $arg {}\"", className = "test1017.MainTest", methodName = "main", fileName = "test1017.kt", lineNumber = 13)
  }
...
private var arg: Long = 42
  fun main() {
    ...
    logger.at(Level.INFO, marker) { message = "info with extension function 42m interval"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"info with extension function {} interval\"", className = "test1018.MainTest", methodName = "main", fileName = "test1018.kt", lineNumber = 13)
  }
...
private val logger = KotlinLogging.logger {}
  ...
  fun main() {
    ...
    logger.at(Level.INFO, marker) { message = "info message 42 Hello!{} abc {}"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"info message {} \" + \"\" + \"{}\" + \"{}\" + \" abc\" + \" {}\"", className = "test1019.MainTest", methodName = "main", fileName = "test1019.kt", lineNumber = 13)
  }
  fun helper() = "Hello!"
}
class MyMarker(private val name: String): Marker { override fun getName() = name }
...
private val logger = KotlinLogging.logger {}
  ...
  fun main() {
    ...
    logger.at(Level.INFO, marker) { message = "info message 1a 2b 12ab ab"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"info message {}a\" + \" {}b\" + \" {}ab\" + \" ab\"", className = "test1020.MainTest", methodName = "main", fileName = "test1020.kt", lineNumber = 13)
  }
  fun ab() = 12
}
class MyMarker(private val name: String): Marker { override fun getName() = name }
