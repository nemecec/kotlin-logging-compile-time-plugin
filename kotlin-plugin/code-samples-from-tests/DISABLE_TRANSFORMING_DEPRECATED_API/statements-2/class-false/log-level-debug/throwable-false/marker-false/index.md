## featureFlag=DISABLE_TRANSFORMING_DEPRECATED_API / With 2 log statement(s) / with class=false / with log level=DEBUG / with throwable=false / with marker=false
...
at(Level.DEBUG) { message = "debug messageBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder\"", className = "test1371.Test1371Kt", methodName = "main", fileName = "test1371.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug messageBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder\"", className = "test1371.Test1371Kt", methodName = "main", fileName = "test1371.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug messageBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder\"", className = "test1371.Test1371Kt", methodName = "main", fileName = "test1371.kt", lineNumber = 13)
}
...
at(Level.DEBUG) { message = "debug messageBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder $i\"", className = "test1372.Test1372Kt", methodName = "main", fileName = "test1372.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug messageBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder $i\"", className = "test1372.Test1372Kt", methodName = "main", fileName = "test1372.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug messageBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder $i\"", className = "test1372.Test1372Kt", methodName = "main", fileName = "test1372.kt", lineNumber = 13)
}
...
at(Level.DEBUG) { message = "debug messageBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder $i ${helper()}\"", className = "test1373.Test1373Kt", methodName = "main", fileName = "test1373.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug messageBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder $i ${helper()}\"", className = "test1373.Test1373Kt", methodName = "main", fileName = "test1373.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug messageBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug messageBuilder $i ${helper()}\"", className = "test1373.Test1373Kt", methodName = "main", fileName = "test1373.kt", lineNumber = 13)
}
fun helper() = "Hello!"
...
at(Level.DEBUG) { message = "debug messageBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "messageLambda", className = "test1374.Test1374Kt", methodName = "main", fileName = "test1374.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug messageBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "messageLambda", className = "test1374.Test1374Kt", methodName = "main", fileName = "test1374.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug messageBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "messageLambda", className = "test1374.Test1374Kt", methodName = "main", fileName = "test1374.kt", lineNumber = 13)
}
...
at(Level.DEBUG) { message = "debug eventBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder\"", className = "test1375.Test1375Kt", methodName = "main", fileName = "test1375.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug eventBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder\"", className = "test1375.Test1375Kt", methodName = "main", fileName = "test1375.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug eventBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder\"", className = "test1375.Test1375Kt", methodName = "main", fileName = "test1375.kt", lineNumber = 13)
}
...
at(Level.DEBUG) { message = "debug eventBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i\"", className = "test1376.Test1376Kt", methodName = "main", fileName = "test1376.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug eventBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i\"", className = "test1376.Test1376Kt", methodName = "main", fileName = "test1376.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug eventBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i\"", className = "test1376.Test1376Kt", methodName = "main", fileName = "test1376.kt", lineNumber = 13)
}
...
at(Level.DEBUG) { message = "debug eventBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i ${helper()}\"", className = "test1377.Test1377Kt", methodName = "main", fileName = "test1377.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug eventBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i ${helper()}\"", className = "test1377.Test1377Kt", methodName = "main", fileName = "test1377.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug eventBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i ${helper()}\"", className = "test1377.Test1377Kt", methodName = "main", fileName = "test1377.kt", lineNumber = 13)
}
fun helper() = "Hello!"
...
at(Level.DEBUG) { message = "debug eventBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder\"", className = "test1378.Test1378Kt", methodName = "main", fileName = "test1378.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug eventBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder\"", className = "test1378.Test1378Kt", methodName = "main", fileName = "test1378.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug eventBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder\"", className = "test1378.Test1378Kt", methodName = "main", fileName = "test1378.kt", lineNumber = 13)
}
...
at(Level.DEBUG) { message = "debug eventBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i\"", className = "test1379.Test1379Kt", methodName = "main", fileName = "test1379.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug eventBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i\"", className = "test1379.Test1379Kt", methodName = "main", fileName = "test1379.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug eventBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i\"", className = "test1379.Test1379Kt", methodName = "main", fileName = "test1379.kt", lineNumber = 13)
}
...
at(Level.DEBUG) { message = "debug eventBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i ${helper()}\"", className = "test1380.Test1380Kt", methodName = "main", fileName = "test1380.kt", lineNumber = 13)
  logger.at(Level.DEBUG) { message = "debug eventBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i ${helper()}\"", className = "test1380.Test1380Kt", methodName = "main", fileName = "test1380.kt", lineNumber = 12)
at(Level.DEBUG) { message = "debug eventBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"debug eventBuilder $i ${helper()}\"", className = "test1380.Test1380Kt", methodName = "main", fileName = "test1380.kt", lineNumber = 13)
}
fun helper() = "Hello!"
