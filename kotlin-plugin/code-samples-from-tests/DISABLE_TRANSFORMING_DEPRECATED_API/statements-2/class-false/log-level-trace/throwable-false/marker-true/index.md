## featureFlag=DISABLE_TRANSFORMING_DEPRECATED_API / With 2 log statement(s) / with class=false / with log level=TRACE / with throwable=false / with marker=true
...
fun main() {
  ...
  logger.at(Level.TRACE, marker) { message = "trace eventBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"trace eventBuilder\"", className = "test1275.Test1275Kt", methodName = "main", fileName = "test1275.kt", lineNumber = 13)
}
...
fun main() {
  ...
  logger.at(Level.TRACE, marker) { message = "trace eventBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"trace eventBuilder $i\"", className = "test1276.Test1276Kt", methodName = "main", fileName = "test1276.kt", lineNumber = 13)
}
...
fun main() {
  ...
  logger.at(Level.TRACE, marker) { message = "trace eventBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"trace eventBuilder $i ${helper()}\"", className = "test1277.Test1277Kt", methodName = "main", fileName = "test1277.kt", lineNumber = 13)
}
fun helper() = "Hello!"
...
fun main() {
  ...
  logger.at(Level.TRACE, marker) { message = "trace eventBuilder"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"trace eventBuilder\"", className = "test1278.Test1278Kt", methodName = "main", fileName = "test1278.kt", lineNumber = 13)
}
...
fun main() {
  ...
  logger.at(Level.TRACE, marker) { message = "trace eventBuilder 42"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"trace eventBuilder $i\"", className = "test1279.Test1279Kt", methodName = "main", fileName = "test1279.kt", lineNumber = 13)
}
...
fun main() {
  ...
  logger.at(Level.TRACE, marker) { message = "trace eventBuilder 42 Hello!"; internalCompilerData = KLoggingEventBuilder.InternalCompilerData(messageTemplate = "\"trace eventBuilder $i ${helper()}\"", className = "test1280.Test1280Kt", methodName = "main", fileName = "test1280.kt", lineNumber = 13)
}
fun helper() = "Hello!"
