# Kotlin compile-time plugin for [kotlin-logging](https://github.com/oshai/kotlin-logging)
...
| 2.2.0          | 1.3.x (latest 1.3.1) |
| 2.2.10         | 1.3.x (latest 1.3.1) |
| 2.2.20         | 1.4.x (latest 1.4.0) |
...
```kotlin
plugins {
  id("dev.nemecec.kotlinlogging.compile-time-plugin") version "1.4.0"
}
...
For even more details, you can check the [code-samples-from-tests](kotlin-plugin/code-samples-from-tests/index.md) directory - it is generated
